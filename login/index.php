...
if (isset($_POST['user'], $_POST['password'])) {
    ...
    if ($result->rowCount() == 0){
        ...
        if ($password1 == NULL)
        {
            ...
            header("Location: https://SITE_URL/login/password.php?data=$encryption");
            exit();
        } 
...
{
    window.location.href="https://SITE_URL/login/register.php";
    return false;
}

function forgot_click()
{
    window.location.href="https://SITE_URL/login/forgot.php?mail=" + $("input#email").val();
    return false;
}
