...
if (isset($_POST["text"])) {
    ...
    file_put_contents(getcwd()."/../admin/updates", "someone wrote us##http://DOMAIN/write/uploads/viewer.php".PHP_EOL, FILE_APPEND);
    ...
    ?> <script> window.alert(<?php echo "'success! we will contact soon'"; ?>); window.location.href = "http://DOMAIN";</script> <?php exit();
}
